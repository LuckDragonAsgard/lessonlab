// WPS_Performing_Arts_LessonPlan_TEMPLATE_v11.docx — VTLM 2.0 fully mandated
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(__dirname + "/WPS_Performing_Arts_LessonPlan_TEMPLATE_v11.docx", buf);
